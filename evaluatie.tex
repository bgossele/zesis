...
Van de eerste soort komen er exact 5549 voor in de \texttt{s\_1092.vcf.gz}-dataset (op ongeveer 500 miljoen genotypes van samples), die steevast voor een error bij het inladen zorgen.\\
...
\bottomrule
\end{tabular}
\caption{Meetresultaten voor de executietijd van queries in Cassandra en SQLite.}
\end{table}
