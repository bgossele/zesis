...
We hebben de performantie gemeten voor de \texttt{s\_1092.vcf.gz}-dataset, in Cassandra-clusters van 5, 7, 10 en 12 nodes. GEMINI draaide op 24 threads verspreid over 2 nodes.
